...
impl SkinManager {
    ...
    pub fn on_create_face_color(&mut self, face_3d_entity: &Entity, face_color_entity: &Entity) {
        self.color_to_face_map
            .insert(*face_color_entity, *face_3d_entity);
        self.face_to_color_map
            .insert(*face_3d_entity, *face_color_entity);
    }

    pub fn on_despawn_face_color(&mut self, face_color_entity: &Entity) {
        self.deregister_face_color(face_color_entity);
    }

    pub fn deregister_face_color(&mut self, face_color_entity: &Entity) {
