            ...
            c.add_panel().set_style(main_container_style).contents(|c| {
                ...
                c.add_panel().set_style(body_container_style).contents(|c| {
                    ...
                    c.add_panel()
                        ...
                        .contents(|c| {
                            c.add_text("forgot your password?").set_style(heading_text_style);

                            c.add_text("enter your email address below and we'll send you instructions to reset your password").set_style(desc_label_style);
