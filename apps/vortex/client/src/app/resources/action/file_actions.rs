...
impl FileActions {
    pub fn execute_file_action(&mut self, world: &mut World, action: FileAction) {
        ...
        let reversed_actions = self.action_stack.execute_action(world, project_entity, action);
        self.action_stack.post_action_execution(world, reversed_actions);
    }
    ...
    pub(crate) fn undo_action(&mut self, world: &mut World, project_root_entity: Entity) {
        ...
        let reversed_actions = self.action_stack.execute_action(world, project_root_entity, action);
