...
use vortex_proto::components::{AnimFrame, AnimRotation, Edge3d, Face3d, FileSystemChild, FileSystemRootChild, IconEdge, IconFace, IconFrame, IconVertex, PaletteColor, ShapeName, Vertex3d, VertexRoot};
