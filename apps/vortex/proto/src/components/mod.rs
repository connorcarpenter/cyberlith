...
pub use shape::{
    Edge3d, EdgeAngle, Face3d, FaceColor, FileExtension, FileType, OwnedByFile, PaletteColor,
    SerdeRotation, ShapeName, Vertex3d, VertexRoot, VertexSerdeInt, BackgroundSkinColor
};
