...
use game_engine::{
    ...
    world::{components::TileMovement, WorldClient},
    time::Instant,
    math::Vec3,
};

use crate::components::{Confirmed, Predicted, RenderHelper, RenderPosition};
        ...
        if predicted_opt.is_some() {
            ...
            // draw predicted future queue
            {
                for (future_tile_x, future_tile_y, _future_instant) in render_position.queue_ref().iter() {
                    ...
                    transform.translation.y = (*future_tile_y as f32) + 50.0;
...

            {
                ...
                transform.translation.y = interp_y + 50.0;
