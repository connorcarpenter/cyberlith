...
pub(crate) async fn handler(
    ...
    let auth_request = UserPasswordForgotRequest::new(&gateway_request.email);

    http_server::log_util::send_req(host_name, auth_server, UserPasswordForgotRequest::name());
