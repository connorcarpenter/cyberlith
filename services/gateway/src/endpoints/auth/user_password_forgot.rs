...
async fn async_impl(incoming_request: GatewayUserPasswordForgotRequest) -> Result<GatewayUserPasswordForgotResponse, ResponseError> {
    ...
    let auth_server_request = AuthUserPasswordForgotRequest::new(
        GATEWAY_SECRET,
