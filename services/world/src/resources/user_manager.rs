...
use super::user_login_token_store::UserLoginTokenStore;
...
impl UserData {
    pub(crate) fn new(user_id: UserId, lobby_id: LobbyId, session_server_addr: &str, session_server_port: u16) -> Self {
        Self {
            user_id,
            lobby_id,
