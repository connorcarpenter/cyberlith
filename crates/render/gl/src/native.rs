...
impl Context {
    ...
    ///
    /// This can be useful when a texture is created outside of gl (e.g. OpenXR surface) but gl
    ...
    ///
    /// This can be useful when a framebuffer is created outside of gl (e.g: via `surfman` or another
    /// crate that supports sharing of buffers between GL contexts), but gl needs to set it as a target.
