...
use crate::Window as BevyWindow;

use three_d::{window::{Window, WindowSettings, FrameOutput}, Camera, vec3, degrees, Color, CpuMesh, Positions, Gm, Mesh, ColorMaterial, ClearState};
...
pub fn three_d_runner(mut app: App) {
    let mut runner = app
        .world
        .remove_non_send_resource::<ThreeDRunner>()
        .unwrap();
