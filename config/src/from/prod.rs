...
#[allow(dead_code)]
pub const SESSION_SERVER_RECV_ADDR: &str = "session_server";
...
pub use crate::from::cpu_priority::{
    ...
    GATEWAY_SERVER_CPU_PRIORITY, REDIRECTOR_SERVER_CPU_PRIORITY, REGION_SERVER_CPU_PRIORITY,
    SESSION_SERVER_CPU_PRIORITY, SOCIAL_SERVER_CPU_PRIORITY, WORLD_SERVER_CPU_PRIORITY,
};
...
pub const TOTAL_CPU_PRIORITY: usize = REGION_SERVER_CPU_PRIORITY
    ...
    + REDIRECTOR_SERVER_CPU_PRIORITY;
